...
app.config['MYSQL_USER'] = 'group16'
app.config['MYSQL_PASSWORD'] = '5lj4zg'
app.config['MYSQL_DB'] = 'group16pa1'
mysql.init_app(app)
...
app.register_blueprint(controllers.ember_api, url_prefix='/b5340568bdcd46b4b5be/pa3')
...
if __name__ == '__main__':
    # listen on external IPs
    app.run(host='0.0.0.0', port=2301, debug=True)
